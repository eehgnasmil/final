...
public interface GoodsRepository extends JpaRepository<Goods, Integer> {
    ...
    @Query("SELECT g, COUNT(gl) as likeCnt, COUNT(o) as orderCnt , COUNT(r) as reviewCnt FROM Goods g " +
            "LEFT JOIN GoodsLike gl ON g = gl.goods " +
            "LEFT JOIN OrderItem o ON g = o.goods " +
            "LEFT JOIN GoodsReview r ON g = r.goods " +
            "WHERE (:category = 0 OR g.category = :category) " +
            "GROUP BY g.idx " +
            "ORDER BY " +
            ...
            "CASE WHEN :orderBy = 'reviewCnt' THEN COUNT(r) END DESC, " +
