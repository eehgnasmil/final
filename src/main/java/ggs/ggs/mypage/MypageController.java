    ...
    public String myModify(@PathVariable("title") String title,
        ...
        switch (title) {
            ...
            case "myBoardLike":
                ...
                model.addAttribute("myBoards", boardlike);
                break;
            ...
            case "myGoodsQnAList":
                Page<GoodsQnADto> goodsQnADtos = goodsCSService.findbyGoodsQnA(id, sortValue, page, category);
            ...
            case "myGoodsReviewList":
                List<ReviewDto> reviewDtos = goodsCSService.findAll(id);
